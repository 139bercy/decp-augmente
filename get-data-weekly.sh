...
wget --no-check-certificate https://www.insee.fr/fr/statistiques/fichier/4316069/departement2020-csv.zip
unzip departement2020-csv.zip
wget --no-check-certificate https://www.insee.fr/fr/statistiques/fichier/4316069/region2020-csv.zip
unzip region2020-csv.zip
wget --no-check-certificate https://www.insee.fr/fr/statistiques/fichier/5057840/commune2021-csv.zip
unzip commune2021-csv.zip
wget --no-check-certificate https://www.insee.fr/fr/statistiques/fichier/5057840/arrondissement2021-csv.zip
